                ...
                <div className="detailes flex ">
                    ...
                    <div className='mt-[30px]'>
                        ...
                        <div className="flex gap-3 justify-around mb-4">
                            ...
                            {/* <span className='min-w-[50px] my-0 mx-[10px] text-center inline-block text-[18px] bg-[white] border-[1px] py-[5px] px-[10px] '>{handleClickQuantity}</span> */}
                            <input type="number" className='value' value={quantity} onChange={handleClickQuantity} />
